...
class LoraCheckpointer(HookBase):
    def __init__(
        self,
    ...
    def after_train(self):
        ...
        model = model_to_local(self._model)
        save_path = os.path.join(self._save_path, "model_alpaca_lora_for_inference")
...
class Trainer(DefaultTrainer):
    def build_hooks(self):
        ...
        ret = [
            ...
            LoraCheckpointer(self.model, self.cfg.train.output_dir),
        ]
