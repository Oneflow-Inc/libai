...
if __name__ == "__main__":
    ...
    model = AutoModelForCausalLM.from_pretrained("jeffwan/vicuna-13b", torch_dtype=flow.float16)
    # set model to cuda
    dist.set_device_type("cuda")
    model._apply(dist.convert_to_distributed_default_setting)
    # initial tokenizer
    tokenizer = AutoTokenizer.from_pretrained("jeffwan/vicuna-13b", use_fast=False)
