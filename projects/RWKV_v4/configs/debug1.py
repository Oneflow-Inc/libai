...
os.environ['RWKV_FLOAT_MODE'] = 'tf32' # tf32 fp32 fp16 bf16
...
load_torch_checkpoint.enable = False
...
model = LazyCall(GPT)(vocab_size=int(os.environ['VOCAB_SIZE']), ctx_len=1024, model_type="RWKV", n_layer=1, n_embd=2048)
