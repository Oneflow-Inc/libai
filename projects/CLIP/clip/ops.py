...
def multi_head_attention_forward(query: Tensor,
    ...
    if attn_mask is not None:
        assert attn_mask.dtype == flow.float32 or attn_mask.dtype == flow.float64 or \
            attn_mask.dtype == flow.float16 or attn_mask.dtype == flow.uint8 or attn_mask.dtype == flow.bool, \
