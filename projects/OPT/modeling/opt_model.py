...
class OPTEmbedding(nn.Module):
    def __init__(
        ...
        self.position_embeddings = SinePositionalEmbedding(
...
class OPTForPreTraining(nn.Module):
    """
    ...
    def __init__(self, cfg) -> None:
        super().__init__()
        self.GPT_model = OPTModel(cfg)
        self.loss_func = OPTLoss()
    ...
    def set_pipeline_stage_id(model: nn.Module):
        ...
        for module_block in model.modules():
            if isinstance(module_block.origin, (OPTEmbedding, CasualMask)):
