...
from .dataset_utils import train_valid_test_dataset_provider
...
def build_train_valid_test_data_iterators(cfg):
    ...
    if cfg.train.start_iter > 0 and cfg.train.consumed_train_samples == 0:
        ...
        cfg.train.consumed_train_samples = cfg.train.start_iter * cfg.train.global_batch_size
    ...
    # Build the datasets.
    train_ds, valid_ds, test_ds = train_valid_test_dataset_provider(cfg, train_val_test_num_samples)
    ...
    return train_dataloader, valid_data_iterator, test_data_iterator
