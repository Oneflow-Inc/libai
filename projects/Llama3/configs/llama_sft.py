...
from projects.Llama3.configs.llama_config import cfg
from projects.Llama3.dataset import AlpacaDataset
from projects.Llama3.tokenizer import LlamaTokenizer
from projects.Llama3.llama import LlamaForCausalLM


# Hyperparameters
weight_decay = 0.1
learning_rate = 5e-5
dataset_path = "/data/home/wujian/work/libai/alpaca_data"
pretrained_model_path = "../../data/hf_models/meta-llama/Meta-Llama-3-8B"
...
tokenization.tokenizer = LazyCall(LlamaTokenizer)(
    pretrained_model_path=os.path.join(pretrained_model_path + "/original", "tokenizer.model")
)
