...
def build_pretraining_data_loader(args, dataset, consumed_samples):
    ...
    if args.dataloader_type == "single":
        batch_sampler = MegatronPretrainingSampler(
            ...
            data_parallel_size=dist.get_data_parallel_world_size(),
        )
...
class MegatronPretrainingRandomSampler:
    ...
    def __iter__(self):
        ...
        random_idx = flow.randperm(bucket_size, generator=g).tolist()
