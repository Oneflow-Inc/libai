...
dataloader.test = [
    LazyCall(build_nlp_test_loader)(dataset=LazyCall(DemoNlpDataset)(data_root="test1",)),
    LazyCall(build_nlp_test_loader)(dataset=LazyCall(DemoNlpDataset)(data_root="test2",)),
]
