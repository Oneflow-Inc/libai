...
DATA_BASE=/workspace/idea_model/idea_bert 

DATA_PATH=$DATA_BASE/output_data/loss_compara_content_sentence
CHECKPOINT_PATH=$DATA_BASE/megatron_model_save/bert-cn-wwm/${prefix}_ckpt
TENSORBOARD_PATH=$DATA_BASE/megatron_model_save/bert-cn-wwm/${prefix}_tensorboard
VOCAB_PATH=$DATA_BASE/bert-base-chinese-vocab.txt
...
SCRIPT_PATH=/workspace/idea_model/idea_bert/Megatron-LM
PY=/opt/conda/bin/python3
run_cmd="$PY -m torch.distributed.launch $DISTRIBUTED_ARGS  ${SCRIPT_PATH}/pretrain_bert.py $@ ${options}"
